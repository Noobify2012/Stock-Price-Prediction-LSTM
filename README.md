...
# Dataset:
The dataset is taken from yahoo finace's website in CSV format. The dataset consists of Open, High, Low and Closing Prices of the 20 tickers identified in our project proposal. stocks from 4th April 2017 to 4th April 2022. 
# Price Indicator:
...
need to adjust this to one day and then one week predictions

# Test:
Test accuracy metric is root mean square error (RMSE).
# Results:
The comparison of OHLC, HLC and Closing price:
this is just old appl data
